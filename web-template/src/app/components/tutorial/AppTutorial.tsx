...
const tutorialSteps: TutorialStep[] = [
  {
    ...
    description: 'Let me show you around your new mental wellness companion',
    position: 'center',
    mascotMessage: "Hi! I\'m Otto, and I\'ll be your guide"
  },
  {
    id: 'home',
    title: 'Your Home Dashboard',
    description: 'Track your daily mood, view insights, and start your wellness journey here',
    position: 'bottom',
  ...
  },
  {
    ...
    description: 'Share how you\'re feeling. I\'ll help you track patterns and provide personalized support',
    position: 'top',
    targetSelector: '[data-tutorial="mood-checkin"]'
  },
  {
    id: 'ai-chat',
    title: 'Your 24/7 AI Therapist 💜',
    description: 'Whenever you need someone to talk to, I\'m always here for you. Get instant emotional support in a safe space, anytime.',
    position: 'bottom',
    targetSelector: '[data-tutorial="ai-chat-button"]',
    highlightBottom: true
  },
  {
    id: 'explore',
    title: 'Explore Content',
    description: 'Discover helpful articles, exercises, and resources curated for your wellbeing',
    position: 'bottom',
  ...
  },
  {
    ...
    description: 'Find and book appointments with licensed therapists who can support you',
    position: 'bottom',
    targetSelector: '[data-tutorial="therapist-card"]'
  },
  {
    id: 'profile',
    title: 'Your Profile',
    description: 'Manage your account, view your progress, and customize your experience',
    position: 'bottom',
