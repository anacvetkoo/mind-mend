...
import { signUpTherapist, loginWithGoogle } from '../../services/auth';
...
export function TherapistSignUpForm({ onSignUpSuccess, onBack }: TherapistSignUpFormProps) {
  ...
  // Stanja za prikaz modalnih oken (privzeto iz UserSignUpForm)
  ...
  const handleGoogleSignUp = async () => {
    ...
    const result = await loginWithGoogle('therapist');
      ...
      <div className="w-full max-w-md mx-auto">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mb-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <label htmlFor="terms" className="text-sm text-muted-foreground cursor-pointer">
                ...
                <button 
                  ...
                  className="text-sm text-[var(--lavender)] underline"
                >
            ...
            <Button
              type="submit"
              disabled={!password || !confirmPassword || !firstName || !lastName || !agreedToTerms || isLoading}
